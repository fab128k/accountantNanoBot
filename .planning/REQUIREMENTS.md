...
- [x] **STACK-04**: sentence-transformers>=3.0.0 aggiunto a requirements.txt; ChromaDB configurato per usare il modello `paraphrase-multilingual-MiniLM-L12-v2` per embedding multilingua
...
- [x] **SCAN-02**: L'utente può selezionare la cartella cliente da UI Streamlit (pagina onboarding o sidebar); il sistema avvia la scansione e mostra i file trovati divisi per categoria
